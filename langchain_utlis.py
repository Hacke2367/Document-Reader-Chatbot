...
#     client = InferenceClient(os.getenv(token="HUGGINGFACEHUB_API_TOKEN"))
#     llm = client.text_generation(model="mistralai/Mistral-7B-v0.1", inputs=prompt, parameters={"max_new_tokens":512, "temperature":0.7})
